...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('/public/assets/admin/assets/vendors/css/vendor.bundle.base.css')}}">
    <!-- endinject -->
    <!-- Plugin css for this page -->
    <!-- End plugin css for this page -->
    <!-- Layout styles -->
    <link rel="stylesheet" href="{{asset('/public/assets/admin/assets/css/demo/style.css')}}">
    <!-- End layout styles -->
    <link rel="shortcut icon" href="{{asset('/public/assets/admin/assets/images/favicon.png')}}" />
  </head>
  <body>
    <script src="{{asset('/public/assets/admin/assets/js/preloader.js')}}"></script>
